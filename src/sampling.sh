...
if [ -z "$1" ] || [ -z "$2" ] || [ -z "$3" ] || [ -z "$4" ] || [ -z "$5" ]; then
    ...
    echo "Usage: $0 <seed_num> <sample_num> <trial_num> <r1_filename> <r2_filename>"
    exit 1
fi
...
./utils/PEAR/pear -f ../result/${seed_num}/${sample_num}/r1_extraNPF_${trial_num}.fastq -r ../result/${seed_num}/${sample_num}/r2_extraNPF_${trial_num}.fastq -o ../result/${seed_num}/${sample_num}/extraNPF_${trial_num} -j 30 # Merging
